        ...
        const fetchCompany = async () => {
            try {
                ...
                setFormData((prev) => ({
                    ...
                    companyTiktok: data.tiktok || "",
                    companyFacebook: data.facebook || "",
                    companyTelegram: data.telegram || "",
                    companyWhatsapp: data.whatsapp || "",
                    companyViber: data.viber || "" ,
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const body: Partial<{
                ...
                companyTiktok: formData.companyTiktok,
                companyFacebook: formData.companyFacebook,
                companyTelegram: formData.companyTelegram,
                companyWhatsapp: formData.companyWhatsapp,
                companyViber: formData.companyViber,
